...
public final class Blocks {
    ...
    public static void register(MTR.RegisterCallback<RegistryObject<Block>> registerBlock, MTR.RegisterBlockItem registerBlockItem) {
        JCMLogger.debug("Registering blocks...");

        registerBlock.register("apg_door_drl", APG_DOOR_DRL);
        registerBlock.register("apg_glass_drl", APG_GLASS_DRL);
        registerBlock.register("apg_glass_end_drl", APG_GLASS_END_DRL);
        registerBlockItem.accept("auto_iron_door", AUTO_IRON_DOOR, ItemGroups.MAIN);
        registerBlockItem.accept("butterfly_light", BUTTERFLY_LIGHT, ItemGroups.MAIN);
        registerBlockItem.accept("buffer_stop", BUFFER_STOP, ItemGroups.MAIN);
        registerBlockItem.accept("ceiling_slanted", CEILING_SLANTED, ItemGroups.MAIN);
        registerBlockItem.accept("circle_wall_1", CIRCLE_WALL_1, ItemGroups.MAIN);
        registerBlockItem.accept("circle_wall_2", CIRCLE_WALL_2, ItemGroups.MAIN);
        registerBlockItem.accept("circle_wall_3", CIRCLE_WALL_3, ItemGroups.MAIN);
        registerBlockItem.accept("circle_wall_4", CIRCLE_WALL_4, ItemGroups.MAIN);
        registerBlockItem.accept("circle_wall_5", CIRCLE_WALL_5, ItemGroups.MAIN);
        registerBlockItem.accept("circle_wall_6", CIRCLE_WALL_6, ItemGroups.MAIN);
        registerBlockItem.accept("circle_wall_7", CIRCLE_WALL_7, ItemGroups.MAIN);
        registerBlockItem.accept("departure_pole", DEPARTURE_POLE, ItemGroups.MAIN);
        registerBlockItem.accept("departure_timer", DEPARTURE_TIMER, ItemGroups.MAIN);
        registerBlockItem.accept("exit_sign_odd", EXIT_SIGN_ODD, ItemGroups.MAIN);
        registerBlockItem.accept("exit_sign_even", EXIT_SIGN_EVEN, ItemGroups.MAIN);
        registerBlockItem.accept("fire_alarm", FIRE_ALARM, ItemGroups.MAIN);
        registerBlockItem.accept("faresaver", FARE_SAVER, ItemGroups.MAIN);
        registerBlockItem.accept("helpline_1", HELPLINE_1, ItemGroups.MAIN);
        registerBlockItem.accept("helpline_2", HELPLINE_2, ItemGroups.MAIN);
        registerBlockItem.accept("helpline_hkwk", HELPLINE_HKWK, ItemGroups.MAIN);
        registerBlockItem.accept("helpline_standing", HELPLINE_STANDING, ItemGroups.MAIN);
        registerBlockItem.accept("helpline_standing_eal", HELPLINE_STANDING_EAL, ItemGroups.MAIN);
        registerBlockItem.accept("kcr_emg_stop_sign", KCR_EMG_STOP_SIGN, ItemGroups.MAIN);
        registerBlockItem.accept("kcr_enquiry_machine", KCR_ENQUIRY_MACHINE, ItemGroups.MAIN);
        registerBlockItem.accept("kcr_name_sign", KCR_STATION_NAME_SIGN, ItemGroups.MAIN);
        registerBlockItem.accept("kcr_name_sign_station_color", KCR_STATION_NAME_SIGN_STATION_COLOR, ItemGroups.MAIN);
        registerBlockItem.accept("kcr_trespass_sign", KCR_TRESPASS_SIGN, ItemGroups.MAIN);
        registerBlockItem.accept("pids_lcd", LCD_PIDS, ItemGroups.PIDS);
        registerBlockItem.accept("light_block", LIGHT_BLOCK, ItemGroups.MAIN);
        registerBlockItem.accept("light_lantern", LIGHT_LANTERN, ItemGroups.MAIN);
        registerBlockItem.accept("lrt_trespass_sign", LRT_TRESPASS_SIGN, ItemGroups.MAIN);
        registerBlockItem.accept("lrt_inter_car_barrier_left", LRT_INTER_CAR_BARRIER_LEFT, ItemGroups.MAIN);
        registerBlockItem.accept("lrt_inter_car_barrier_middle", LRT_INTER_CAR_BARRIER_MIDDLE, ItemGroups.MAIN);
        registerBlockItem.accept("lrt_inter_car_barrier_right", LRT_INTER_CAR_BARRIER_RIGHT, ItemGroups.MAIN);
        registerBlockItem.accept("mtr_enquiry_machine", MTR_ENQUIRY_MACHINE, ItemGroups.MAIN);
        registerBlockItem.accept("mtr_enquiry_machine_wall", MTR_ENQUIRY_MACHINE_WALL, ItemGroups.MAIN);
        registerBlockItem.accept("mtr_stairs", MTR_STAIRS, ItemGroups.MAIN);
        registerBlockItem.accept("mtr_trespass_sign", MTR_TRESPASS_SIGN, ItemGroups.MAIN);
        registerBlockItem.accept("operator_button", OPERATOR_BUTTON, ItemGroups.MAIN);
        registerBlockItem.accept("pids_projector", PIDS_PROJECTOR, ItemGroups.PIDS);
        registerBlockItem.accept("pids_1a", PIDS_1A, ItemGroups.PIDS);
        registerBlockItem.accept("pids_rv", RV_PIDS, ItemGroups.PIDS);
        registerBlockItem.accept("pids_rv_sil_1", RV_PIDS_SIL_1, ItemGroups.PIDS);
        registerBlockItem.accept("pids_rv_sil_2", RV_PIDS_SIL_2, ItemGroups.PIDS);
        registerBlockItem.accept("rv_pids_pole", RV_PIDS_POLE, ItemGroups.PIDS);
        registerBlockItem.accept("rv_enquiry_machine", RV_ENQUIRY_MACHINE, ItemGroups.MAIN);
        registerBlockItem.accept("sil_emg_stop_button", SIL_EMG_STOP_BUTTON, ItemGroups.MAIN);
        registerBlockItem.accept("signal_light_inverted_1", SIGNAL_LIGHT_INVERTED_RED_ABOVE, ItemGroups.MAIN);
        registerBlockItem.accept("signal_light_inverted_2", SIGNAL_LIGHT_INVERTED_RED_BOTTOM, ItemGroups.MAIN);
        registerBlockItem.accept("signal_light_red_1", STATIC_SIGNAL_LIGHT_RED_BELOW, ItemGroups.MAIN);
        registerBlockItem.accept("signal_light_red_2", STATIC_SIGNAL_LIGHT_RED_TOP, ItemGroups.MAIN);
        registerBlockItem.accept("signal_light_green", STATIC_SIGNAL_LIGHT_GREEN, ItemGroups.MAIN);
        registerBlockItem.accept("signal_light_blue", STATIC_SIGNAL_LIGHT_BLUE, ItemGroups.MAIN);
        registerBlockItem.accept("spot_lamp", SPOT_LAMP, ItemGroups.MAIN);
        registerBlockItem.accept("station_name_standing", STATION_NAME_STANDING, ItemGroups.MAIN);
        registerBlockItem.accept("subsidy_machine", SUBSIDY_MACHINE, ItemGroups.MAIN);
        registerBlockItem.accept("sound_looper", SOUND_LOOPER, ItemGroups.MAIN);
        registerBlockItem.accept("station_ceiling_wrl", STATION_CEILING_WRL, ItemGroups.MAIN);
        registerBlockItem.accept("station_ceiling_wrl_single", STATION_CEILING_WRL_SINGLE, ItemGroups.MAIN);
        registerBlockItem.accept("station_ceiling_wrl_station_color", STATION_CEILING_WRL_STATION_COLOR, ItemGroups.MAIN);
        registerBlockItem.accept("station_ceiling_wrl_single_station_color", STATION_CEILING_WRL_SINGLE_STATION_COLOR, ItemGroups.MAIN);
        registerBlockItem.accept("station_ceiling_wrl_pole", STATION_CEILING_WRL_POLE, ItemGroups.MAIN);
        registerBlockItem.accept("station_ceiling_wrl_single_pole", STATION_CEILING_WRL_POLE_SINGLE, ItemGroups.MAIN);
        registerBlockItem.accept("tcl_emg_stop_button", TCL_EMG_STOP_BUTTON, ItemGroups.MAIN);
        registerBlockItem.accept("thales_ticket_barrier_entrance", THALES_TICKET_BARRIER_ENTRANCE, ItemGroups.MAIN);
        registerBlockItem.accept("thales_ticket_barrier_exit", THALES_TICKET_BARRIER_EXIT, ItemGroups.MAIN);
        registerBlockItem.accept("thales_ticket_barrier_bare", THALES_TICKET_BARRIER_BARE, ItemGroups.MAIN);
        registerBlockItem.accept("tml_emg_stop_button", TML_EMG_STOP_BUTTON, ItemGroups.MAIN);
        registerBlockItem.accept("train_model_e44", TRAIN_MODEL_E44, ItemGroups.MAIN);

        registerBlockItem.accept("water_machine", WATER_MACHINE, ItemGroups.MAIN);
