...
public final class Blocks {
    ...
    public static void register(RegistriesWrapper registriesWrapper) {
        ...
        registriesWrapper.registerBlock("apg_door_drl", APG_DOOR_DRL);
        registriesWrapper.registerBlock("apg_glass_drl", APG_GLASS_DRL);
        registriesWrapper.registerBlock("apg_glass_end_drl", APG_GLASS_END_DRL);
        registriesWrapper.registerBlockAndItem("auto_iron_door", AUTO_IRON_DOOR, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("butterfly_light", BUTTERFLY_LIGHT, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("buffer_stop", BUFFER_STOP, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("ceiling_slanted", CEILING_SLANTED, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("circle_wall_1", CIRCLE_WALL_1, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("circle_wall_2", CIRCLE_WALL_2, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("circle_wall_3", CIRCLE_WALL_3, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("circle_wall_4", CIRCLE_WALL_4, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("circle_wall_5", CIRCLE_WALL_5, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("circle_wall_6", CIRCLE_WALL_6, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("circle_wall_7", CIRCLE_WALL_7, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("departure_pole", DEPARTURE_POLE, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("departure_timer", DEPARTURE_TIMER, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("exit_sign_odd", EXIT_SIGN_ODD, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("exit_sign_even", EXIT_SIGN_EVEN, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("fire_alarm", FIRE_ALARM, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("faresaver", FARE_SAVER, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("helpline_1", HELPLINE_1, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("helpline_2", HELPLINE_2, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("helpline_hkwk", HELPLINE_HKWK, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("helpline_standing", HELPLINE_STANDING, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("helpline_standing_eal", HELPLINE_STANDING_EAL, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("kcr_emg_stop_sign", KCR_EMG_STOP_SIGN, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("kcr_enquiry_machine", KCR_ENQUIRY_MACHINE, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("kcr_name_sign", KCR_STATION_NAME_SIGN, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("kcr_name_sign_station_color", KCR_STATION_NAME_SIGN_STATION_COLOR, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("kcr_trespass_sign", KCR_TRESPASS_SIGN, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("pids_lcd", LCD_PIDS, ItemGroups.PIDS);
        registriesWrapper.registerBlockAndItem("light_block", LIGHT_BLOCK, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("light_lantern", LIGHT_LANTERN, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("lrt_trespass_sign", LRT_TRESPASS_SIGN, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("lrt_inter_car_barrier_left", LRT_INTER_CAR_BARRIER_LEFT, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("lrt_inter_car_barrier_middle", LRT_INTER_CAR_BARRIER_MIDDLE, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("lrt_inter_car_barrier_right", LRT_INTER_CAR_BARRIER_RIGHT, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("mtr_enquiry_machine", MTR_ENQUIRY_MACHINE, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("mtr_enquiry_machine_wall", MTR_ENQUIRY_MACHINE_WALL, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("mtr_stairs", MTR_STAIRS, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("mtr_trespass_sign", MTR_TRESPASS_SIGN, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("operator_button", OPERATOR_BUTTON, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("pids_projector", PIDS_PROJECTOR, ItemGroups.PIDS);
        registriesWrapper.registerBlockAndItem("pids_1a", PIDS_1A, ItemGroups.PIDS);
        registriesWrapper.registerBlockAndItem("pids_rv", RV_PIDS, ItemGroups.PIDS);
        registriesWrapper.registerBlockAndItem("pids_rv_sil_1", RV_PIDS_SIL_1, ItemGroups.PIDS);
        registriesWrapper.registerBlockAndItem("pids_rv_sil_2", RV_PIDS_SIL_2, ItemGroups.PIDS);
        registriesWrapper.registerBlockAndItem("rv_pids_pole", RV_PIDS_POLE, ItemGroups.PIDS);
        registriesWrapper.registerBlockAndItem("rv_enquiry_machine", RV_ENQUIRY_MACHINE, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("sil_emg_stop_button", SIL_EMG_STOP_BUTTON, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("signal_light_inverted_1", SIGNAL_LIGHT_INVERTED_RED_ABOVE, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("signal_light_inverted_2", SIGNAL_LIGHT_INVERTED_RED_BOTTOM, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("signal_light_red_1", STATIC_SIGNAL_LIGHT_RED_BELOW, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("signal_light_red_2", STATIC_SIGNAL_LIGHT_RED_TOP, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("signal_light_green", STATIC_SIGNAL_LIGHT_GREEN, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("signal_light_blue", STATIC_SIGNAL_LIGHT_BLUE, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("spot_lamp", SPOT_LAMP, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("station_name_standing", STATION_NAME_STANDING, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("subsidy_machine", SUBSIDY_MACHINE, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("sound_looper", SOUND_LOOPER, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("station_ceiling_wrl", STATION_CEILING_WRL, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("station_ceiling_wrl_single", STATION_CEILING_WRL_SINGLE, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("station_ceiling_wrl_station_color", STATION_CEILING_WRL_STATION_COLOR, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("station_ceiling_wrl_single_station_color", STATION_CEILING_WRL_SINGLE_STATION_COLOR, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("station_ceiling_wrl_pole", STATION_CEILING_WRL_POLE, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("station_ceiling_wrl_single_pole", STATION_CEILING_WRL_POLE_SINGLE, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("tcl_emg_stop_button", TCL_EMG_STOP_BUTTON, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("thales_ticket_barrier_entrance", THALES_TICKET_BARRIER_ENTRANCE, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("thales_ticket_barrier_exit", THALES_TICKET_BARRIER_EXIT, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("thales_ticket_barrier_bare", THALES_TICKET_BARRIER_BARE, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("tml_emg_stop_button", TML_EMG_STOP_BUTTON, ItemGroups.MAIN);
        registriesWrapper.registerBlockAndItem("train_model_e44", TRAIN_MODEL_E44, ItemGroups.MAIN);

        registriesWrapper.registerBlockAndItem("water_machine", WATER_MACHINE, ItemGroups.MAIN);
