...
public class MSDMainClient {
    public static void init() {
        ...
        MTRClient.registerAddonConfigGUICallback(MSDMain.ADDON, (prevScreen) -> Minecraft.getInstance().setScreen(new ConfigScreen(prevScreen)));
    }

    public static void registerItemModelPredicates() {
        MSDRegistryClient.registerItemModelPredicate(MSDMain.MOD_ID + ":selected", MSDItems.CATENARY_REMOVER.get(), ItemMSDBlockClickingBase.TAG_POS);
        MSDRegistryClient.registerItemModelPredicate(MSDMain.MOD_ID + ":selected", MSDItems.ELECTRIC_CONNECTOR.get(), ItemMSDBlockClickingBase.TAG_POS);
        MSDRegistryClient.registerItemModelPredicate(MSDMain.MOD_ID + ":selected", MSDItems.CATENARY_CONNECTOR.get(), ItemMSDBlockClickingBase.TAG_POS);
        MSDRegistryClient.registerItemModelPredicate(MSDMain.MOD_ID + ":selected", MSDItems.RIGID_CATENARY_CONNECTOR.get(), ItemMSDBlockClickingBase.TAG_POS);
        MSDRegistryClient.registerItemModelPredicate(MSDMain.MOD_ID + ":selected", MSDItems.RIGID_CATENARY_REMOVER.get(), ItemMSDBlockClickingBase.TAG_POS);
        MSDRegistryClient.registerItemModelPredicate(MSDMain.MOD_ID + ":selected", MSDItems.RIGID_SOFT_CATENARY_CONNECTOR.get(), ItemMSDBlockClickingBase.TAG_POS);
        MSDRegistryClient.registerItemModelPredicate(MSDMain.MOD_ID + ":selected", MSDItems.TRANS_CATENARY_CONNECTOR.get(),ItemMSDBlockClickingBase.TAG_POS);
        MSDRegistryClient.registerItemModelPredicate(MSDMain.MOD_ID + ":selected", MSDItems.TRANS_CATENARY_REMOVER.get(),ItemMSDBlockClickingBase.TAG_POS);
        MSDRegistryClient.registerItemModelPredicate(MSDMain.MOD_ID + ":selected", MSDItems.TRANS_ELECTRIC_CONNECTOR.get(), ItemMSDBlockClickingBase.TAG_POS);
    }
}