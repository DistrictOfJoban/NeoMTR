...
public class MSDMain {
    ...
    public static void init(
        ...
        Registry.registerNetworkPacket(PACKET_YAMANOTE_SIGN_TYPES);
        Registry.registerNetworkPacket(PACKET_CUSTOM_TEXT_SIGN_UPDATE);
        Registry.registerNetworkPacket(PACKET_BLOCK_NODE_POS_UPDATE);

        Registry.registerNetworkPacket(MSDPacket.PACKET_OPEN_YAMANOTE_RAILWAY_SIGN_SCREEN);
        Registry.registerNetworkPacket(MSDPacket.PACKET_WRITE_CATENARY);
        Registry.registerNetworkPacket(MSDPacket.PACKET_REMOVE_CATENARY_NODE);
        Registry.registerNetworkPacket(MSDPacket.PACKET_CREATE_CATENARY);
        Registry.registerNetworkPacket(MSDPacket.PACKET_REMOVE_CATENARY);
        Registry.registerNetworkPacket(MSDPacket.PACKET_WRITE_RIGID_CATENARY);
        Registry.registerNetworkPacket(MSDPacket.PACKET_REMOVE_RIGID_CATENARY_NODE);
        Registry.registerNetworkPacket(MSDPacket.PACKET_CREATE_RIGID_CATENARY);
        Registry.registerNetworkPacket(MSDPacket.PACKET_REMOVE_RIGID_CATENARY);
        Registry.registerNetworkPacket(MSDPacket.PACKET_OPEN_CUSTOM_TEXT_SIGN_CONFIG_SCREEN);
        Registry.registerNetworkPacket(MSDPacket.PACKET_OPEN_BLOCK_NODE_SCREEN);
        Registry.registerNetworkPacket(MSDPacket.PACKET_WRITE_TRANS_CATENARY);
        Registry.registerNetworkPacket(MSDPacket.PACKET_CREATE_TRANS_CATENARY);
        Registry.registerNetworkPacket(MSDPacket.PACKET_REMOVE_TRANS_CATENARY);
        Registry.registerNetworkPacket(MSDPacket.PACKET_REMOVE_TRANS_CATENARY_NODE);
