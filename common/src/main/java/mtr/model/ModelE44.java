...
public class ModelE44 extends ModelSimpleTrainBase<ModelE44> {
    ...
    private static final ModelDoorOverlayTopMLR MODEL_DOOR_OVERLAY_TOP = new ModelDoorOverlayTopMLR("mtr:textures/entity/door_overlay/door_overlay_e44_top.png");
