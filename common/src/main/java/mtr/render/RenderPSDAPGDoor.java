...
public class RenderPSDAPGDoor<T extends BlockPSDAPGDoorBase.TileEntityPSDAPGDoorBase> extends BlockEntityRendererMapper<T> implements IGui, IBlock {
	...
	public void render(T entity, float tickDelta, PoseStack matrices, MultiBufferSource vertexConsumers, int light, int overlay) {
		...
		switch (type) {
			...
			case 1:
				if (half) {
					MainRenderer.scheduleRender(ResourceLocation.parse(String.format("mtr:textures/block/light_%s.png", open > 0 ? "on" : "off")), false, open > 0 ? MainRenderer.QueuedRenderLayer.LIGHT : MainRenderer.QueuedRenderLayer.EXTERIOR, (matricesNew, vertexConsumer) -> {
				...
				if (end) {
					MainRenderer.scheduleRender(ResourceLocation.parse(String.format("mtr:textures/entity/psd_apg_door/psd_door_end_%s_%s_2_%s.png", half ? "top" : "bottom", side ? "right" : "left", type == 1 ? "2" : "1")), false, MainRenderer.QueuedRenderLayer.EXTERIOR, (matricesNew, vertexConsumer) -> {
						storedMatrixTransformationsLight.transform(matricesNew);
			...
			case 2:
				if (half) {
					...
					if (block instanceof BlockAPGGlass || block instanceof BlockAPGGlassEnd) {
						MainRenderer.scheduleRender(ResourceLocation.parse(String.format("mtr:textures/block/apg_door_light_%s.png", open > 0 ? "on" : "off")), false, open > 0 ? MainRenderer.QueuedRenderLayer.LIGHT_TRANSLUCENT : MainRenderer.QueuedRenderLayer.EXTERIOR, (matricesNew, vertexConsumer) -> {
							storedMatrixTransformationsLight.transform(matricesNew);
		...
		switch (type) {
			...
			case 1:
				if (end) {
					MainRenderer.scheduleRender(ResourceLocation.parse(String.format("mtr:textures/entity/psd_apg_door/psd_door_end_%s_%s_1_%s.png", half ? "top" : "bottom", side ? "right" : "left", type == 1 ? "2" : "1")), false, MainRenderer.QueuedRenderLayer.EXTERIOR, (matricesNew, vertexConsumer) -> {
					...
					MainRenderer.scheduleRender(ResourceLocation.parse(String.format("mtr:textures/entity/psd_apg_door/psd_door_%s_%s_%s.png", half ? "top" : "bottom", side ? "right" : "left", type == 1 ? "2" : "1")), false, MainRenderer.QueuedRenderLayer.EXTERIOR, (matricesNew, vertexConsumer) -> {
						storedMatrixTransformations.transform(matricesNew);
				...
				if (half && !unlocked) {
					MainRenderer.scheduleRender(ResourceLocation.parse("mtr:textures/block/sign/door_not_in_use.png"), false, MainRenderer.QueuedRenderLayer.EXTERIOR, (matricesNew, vertexConsumer) -> {
						storedMatrixTransformations.transform(matricesNew);
						if (end) {
				...
				break;
			case 2:
				MainRenderer.scheduleRender(ResourceLocation.parse(String.format("mtr:textures/entity/psd_apg_door/apg_door_%s_%s.png", half ? "top" : "bottom", side ? "right" : "left")), false, MainRenderer.QueuedRenderLayer.EXTERIOR, (matricesNew, vertexConsumer) -> {
					storedMatrixTransformations.transform(matricesNew);
			...
			case 3:
				MainRenderer.scheduleRender(ResourceLocation.parse(String.format("mtr:textures/entity/psd_apg_door/lift_door_%s_%s_1.png", half ? "top" : "bottom", side ? "right" : "left")), false, MainRenderer.QueuedRenderLayer.EXTERIOR, (matricesNew, vertexConsumer) -> {
					storedMatrixTransformations.transform(matricesNew);
