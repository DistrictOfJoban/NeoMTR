...
public class BlockRoundelStationTypeC extends BlockRoundelBase {
	...
	public BlockRoundelStationTypeC(BlockBehaviour.Properties settings) {
		super(settings);
	}
	...
	public BlockEntityMapper createBlockEntity(BlockPos pos, BlockState state) {
		return new TileEntityBlockRoundelStationTypeC(pos, state);
	}

	public static class TileEntityBlockRoundelStationTypeC extends TileEntityBlockRoundelBase {
