...
import net.londonunderground.mod.registry.SoundEvents;
...
public class SoundTubeStationAmbience1 extends BlockMapper {
	...
	public SoundTubeStationAmbience1(BlockBehaviour.Properties settings) {
		super(settings);
	}
...
//		System.out.println("play");
		world.playSound(
				...
				SoundEvents.SOUNT_EVENT_TUBE_STATION_AMBIENCE1, // The sound that will play
