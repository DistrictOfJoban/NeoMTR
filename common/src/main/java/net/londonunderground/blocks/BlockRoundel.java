...
public class BlockRoundel extends BlockRoundelBase {
	...
	public BlockRoundel(BlockBehaviour.Properties settings) {
		super(settings);
	}
	...
	public BlockEntityMapper createBlockEntity(BlockPos pos, BlockState state) {
		return new TileEntityBlockRoundel(pos, state);
	}

	public static class TileEntityBlockRoundel extends TileEntityBlockRoundelBase {

		public TileEntityBlockRoundel(BlockPos pos, BlockState state) {
			super(BlockEntityTypes.BLOCK_ROUNDEL_TILE_ENTITY.get(), pos, state);
		}
